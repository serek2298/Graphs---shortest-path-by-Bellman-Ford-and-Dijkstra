...
//
//template<typename Type, int MAXIMUM>
//std::vector<int> GrafList<Type, MAXIMUM>::neighbours(int vertex) const {
//    std::vector<int> Vs;
//    for(auto E : Edges){
//        if(E.source == vertex){
...
//void GrafList<Type, MAXIMUM>::CopyFromFile(const std::string& path) {
//    std::fstream file;
...
//
//template<typename Type, int MAXIMUM>
//int GrafList<Type, MAXIMUM>::getEdge(int source, int target)const{
//    assert(source<this->size() && target < this->size());
//    for(int i = 0;i<this->Edges.size();i++){
